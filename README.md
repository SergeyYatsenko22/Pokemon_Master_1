...
В этом учебном проекте через админку можно добавлять покемонов, их характеристики и расположение покемонов на карте с учетом времени появления и изчезновения.
